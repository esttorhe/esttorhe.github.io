...
date: 2021-02-09
category: Tech
description: "How to fix the annoying jittering behavior in Safari's URL bar when selecting suggestions."
tags:
  - engineering
  - code
  - safari
...
Fast forward a couple of weeks and I'm happy with `Safari` for the most part… except that I do have multiple email accounts with the same provider (because of reasons) and when typing `mail` on my search bar and getting a few hits; hitting the downwards arrow to get to the one I wanted and seeing the selection jump last minute to the top started to get on my nerves…
