---
title: "Xcode notifications on your phone"
date: 2018-02-13T18:18:04Z
tags:
  - xcode
  - notifications
  - ntfy
  ...
  - tools
category: Tech
description: "How to get Xcode build notifications on your phone using ntfy - perfect for long compilation times."
---
...
That is until today when I found out about [`ntfy`](https://github.com/dschep/ntfy)…
...
_You might have noticed the `-b telegram` part. This you can check how to configure on [`ntfy`](https://github.com/dschep/ntfy)'s `README`; if you don't want to use `Telegram` you can tweak it to use any of the other supported services._
