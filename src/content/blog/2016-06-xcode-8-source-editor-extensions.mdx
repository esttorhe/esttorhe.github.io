...
date: 2016-06-27
category: Tech
description: "Tips for developing Xcode 8 Source Editor Extensions, including a fix for extensions failing to load."
tags:
  - xcode
  - xcode 8
  - extensions
...
<GitHubRepo owner="esttorhe" repo="Localizer" commit="3831a7" />

---

## The basics

[Apple's documentation on Xcode 8 Source Editor Extensions](https://developer.apple.com/app-extensions/) is pretty «nice» for an upcoming, yet to be released, feature.

There's also [session 414](https://developer.apple.com/videos/play/wwdc2016/414/) from `WWDC 16` that covers all the details.

Here's yet another [blog post](http://www.russbishop.net/xcode-extensions) about the topic.
...
It's covered in [this blog post](http://www.russbishop.net/xcode-extensions) and its related to developing Source Editor Extensions in `macOS` 10.11.
...
And there was no sign of the party emoji most of the times, also, my `Localizer` entry under `Editor` menu was grayed out…

I was going to quit after 15 minutes trying to debug/run my extension when I realized something on my `Activity Monitor`:

![XPC Process in Activity Monitor](/assets/images/post/2016/06/Xcode-8-Source-Editor-Extensions/XPC.png)
...
*Thanks [@jseravalli](https://github.com/jseravalli) for the `TL;DR` tip*
